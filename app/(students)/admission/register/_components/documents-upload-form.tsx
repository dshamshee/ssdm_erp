...
export const DocumentsUploadForm = ({ form }: { form: UseFormReturn<DocumentsUploadType> }) => {
            ...
            <div className="flex flex-col gap-2">
              ...
              {fileNames[name] && (
                <div className="flex items-center gap-1.5 text-xs text-emerald-600 bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-900/30 px-3 py-1.5 rounded-full w-fit max-w-full">
                  ...
                  <span className="font-semibold truncate max-w-[200px]">{fileNames[name]}</span>
                </div>
              )}
    ...
    <Card className="border border-muted-foreground/10 shadow-md">
      <CardHeader>
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="font-semibold text-xl">Documents Upload</CardTitle>
        </div>
        <CardDescription>Upload scanned copies of required certificates and documents.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-8">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-2 border-b border-muted-foreground/10 pb-2">
            ...
            <h3 className="text-base font-bold text-foreground">Required Documents</h3>
          </div>
        ...
        <div className="space-y-6 pt-4 border-t border-muted-foreground/10">
          <div className="flex items-center gap-2 pb-2">
            ...
            <h3 className="text-base font-bold text-foreground">Category-specific Documents (If Applicable)</h3>
          </div>
